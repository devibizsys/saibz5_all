...
public class TicketValidationFilter extends AbstractTicketValidationFilter {
    ...
    protected void initInternal(final FilterConfig filterConfig) throws ServletException {
    	this.setServerName(getPropertyFromInitParams(filterConfig, "SERVERNAME", null));
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        ...
        final String casServerUrlPrefix = getPropertyFromInitParams(filterConfig, "UACSERVER", null);

...
@CodeList(id="1f5ad8697b08ee7903446c306e2323cc",name="任务时刻月天",type="STATIC",userscope=false,emptytext="未定义",ormode="STR",valueseparator=",",textseparator="、")
 ...
 * 静态代码表[任务时刻月天]模型基类
 */
public abstract class TSDayCodeListModelBase extends net.ibizsys.paas.sysmodel.StaticCodeListModelBase  {
    ...
    public TSDayCodeListModelBase() {
        super();
        this.initAnnotation(TSDayCodeListModelBase.class);

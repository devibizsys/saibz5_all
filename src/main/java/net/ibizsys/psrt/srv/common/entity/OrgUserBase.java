...
public abstract class OrgUserBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private static final Log log = LogFactory.getLog(OrgUserBase.class);
    /**
     * 属性[条线代码]
     */
    ...
    private final static int INDEX_TITLENAME = 45;
    private final static int INDEX_UPDATEDATE = 46;
    private final static int INDEX_UPDATEMAN = 47;
    private final static int INDEX_USERCODE = 48;
    private final static int INDEX_USERDATA = 49;
    private final static int INDEX_USERDATA2 = 50;
    private final static int INDEX_VALIDFLAG = 51;
    ...
    private static  void fillJSONObject(OrgUserBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getUserCode()!=null) {
            JSONObjectHelper.put(json,"usercode",getJSONValue(et.getUserCode()),false);
        }
    ...
    private static void copyTo(OrgUserBase et,IDataObject dst,boolean bIncEmpty) throws Exception {
        ...
        if(et.isUserCodeDirty() && (bIncEmpty||et.getUserCode()!=null)) {
            dst.set(FIELD_USERCODE,et.getUserCode());
        }

...
/**
 * 实体逻辑处理[更新当前用户]模型对象基类
 */
public abstract class OrgUserUpdateCurUserLogicModelBase extends net.ibizsys.paas.demodel.DELogicModelBase<OrgUser> {
    ...
    */
    protected void executeDeaction1(IActionContext iActionContext) throws Exception {
        ...
        service.executeAction(net.ibizsys.psrt.srv.common.service.OrgUserService.ACTION_UPDATE,_default);

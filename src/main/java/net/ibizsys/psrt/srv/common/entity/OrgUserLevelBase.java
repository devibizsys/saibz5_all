...
public abstract class OrgUserLevelBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private final static int INDEX_RESERVER10 = 8;
    private final static int INDEX_RESERVER11 = 9;
    private final static int INDEX_RESERVER12 = 10;
    private final static int INDEX_RESERVER13 = 11;
    private final static int INDEX_RESERVER14 = 12;
    private final static int INDEX_RESERVER15 = 13;
    private final static int INDEX_RESERVER16 = 14;
    private final static int INDEX_RESERVER17 = 15;
    private final static int INDEX_RESERVER18 = 16;
    private final static int INDEX_RESERVER19 = 17;
    private final static int INDEX_RESERVER2 = 18;
    private final static int INDEX_RESERVER20 = 19;
    private final static int INDEX_RESERVER21 = 20;
    private final static int INDEX_RESERVER22 = 21;
    private final static int INDEX_RESERVER23 = 22;
    private final static int INDEX_RESERVER24 = 23;
    private final static int INDEX_RESERVER25 = 24;
    private final static int INDEX_RESERVER26 = 25;
    private final static int INDEX_RESERVER27 = 26;
    private final static int INDEX_RESERVER28 = 27;
    private final static int INDEX_RESERVER29 = 28;
    private final static int INDEX_RESERVER3 = 29;
    private final static int INDEX_RESERVER30 = 30;
    private final static int INDEX_RESERVER4 = 31;
    private final static int INDEX_RESERVER5 = 32;
    private final static int INDEX_RESERVER6 = 33;
    private final static int INDEX_RESERVER7 = 34;
    private final static int INDEX_RESERVER8 = 35;
    private final static int INDEX_RESERVER9 = 36;
    private final static int INDEX_UPDATEDATE = 37;
    private final static int INDEX_UPDATEMAN = 38;
    private final static int INDEX_VALIDFLAG = 39;
    ...
    private static  void fillJSONObject(OrgUserLevelBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getOrgUserLevelId()!=null) {
            JSONObjectHelper.put(json,"orguserlevelid",getJSONValue(et.getOrgUserLevelId()),false);
        }
        if(bIncEmpty||et.getOrgUserLevelName()!=null) {
            JSONObjectHelper.put(json,"orguserlevelname",getJSONValue(et.getOrgUserLevelName()),false);
        }

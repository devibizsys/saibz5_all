...
public abstract class OrgUnitCatBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private static final Log log = LogFactory.getLog(OrgUnitCatBase.class);
    /**
     * 属性[类别代码]
     */
    ...
    private final static int INDEX_RESERVER10 = 7;
    private final static int INDEX_RESERVER11 = 8;
    private final static int INDEX_RESERVER12 = 9;
    private final static int INDEX_RESERVER13 = 10;
    private final static int INDEX_RESERVER14 = 11;
    private final static int INDEX_RESERVER15 = 12;
    private final static int INDEX_RESERVER16 = 13;
    private final static int INDEX_RESERVER17 = 14;
    private final static int INDEX_RESERVER18 = 15;
    private final static int INDEX_RESERVER19 = 16;
    private final static int INDEX_RESERVER2 = 17;
    private final static int INDEX_RESERVER20 = 18;
    private final static int INDEX_RESERVER21 = 19;
    private final static int INDEX_RESERVER22 = 20;
    private final static int INDEX_RESERVER23 = 21;
    private final static int INDEX_RESERVER24 = 22;
    private final static int INDEX_RESERVER25 = 23;
    private final static int INDEX_RESERVER26 = 24;
    private final static int INDEX_RESERVER27 = 25;
    private final static int INDEX_RESERVER28 = 26;
    private final static int INDEX_RESERVER29 = 27;
    private final static int INDEX_RESERVER3 = 28;
    private final static int INDEX_RESERVER30 = 29;
    private final static int INDEX_RESERVER4 = 30;
    private final static int INDEX_RESERVER5 = 31;
    private final static int INDEX_RESERVER6 = 32;
    private final static int INDEX_RESERVER7 = 33;
    private final static int INDEX_RESERVER8 = 34;
    private final static int INDEX_RESERVER9 = 35;
    private final static int INDEX_UPDATEDATE = 36;
    private final static int INDEX_UPDATEMAN = 37;
    private final static int INDEX_VALIDFLAG = 38;
    ...
    private static  void fillJSONObject(OrgUnitCatBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        if(bIncEmpty||et.getCatCode()!=null) {
            JSONObjectHelper.put(json,"catcode",getJSONValue(et.getCatCode()),false);
        }
        ...
        if(bIncEmpty||et.getOrgUnitCatId()!=null) {
            JSONObjectHelper.put(json,"orgunitcatid",getJSONValue(et.getOrgUnitCatId()),false);
        }
        if(bIncEmpty||et.getOrgUnitCatName()!=null) {
            JSONObjectHelper.put(json,"orgunitcatname",getJSONValue(et.getOrgUnitCatName()),false);
        }
    ...
    private static void copyTo(OrgUnitCatBase et,IDataObject dst,boolean bIncEmpty) throws Exception {
        if(et.isCatCodeDirty() && (bIncEmpty||et.getCatCode()!=null)) {
            dst.set(FIELD_CATCODE,et.getCatCode());
        }
        ...
        if(et.isOrgUnitCatIdDirty() && (bIncEmpty||et.getOrgUnitCatId()!=null)) {
            dst.set(FIELD_ORGUNITCATID,et.getOrgUnitCatId());
        }
        if(et.isOrgUnitCatNameDirty() && (bIncEmpty||et.getOrgUnitCatName()!=null)) {
            dst.set(FIELD_ORGUNITCATNAME,et.getOrgUnitCatName());
        }

...
public abstract class OrgSecUserTypeServiceBase extends net.ibizsys.psrt.srv.PSRuntimeSysServiceBase<OrgSecUserType> {
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver10(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER10);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver11(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER11);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver12(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER12);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver13(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER13);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver14(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER14);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver15(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER15);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver16(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER16);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver17(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER17);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver18(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER18);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver19(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER19);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver2(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER2);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver20(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER20);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver21(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER21);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver22(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER22);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver23(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER23);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver24(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER24);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver25(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER25);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver26(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER26);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver27(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER27);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver28(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER28);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver29(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER29);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver3(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER3);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver30(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER30);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver4(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER4);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver5(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER5);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver6(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER6);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver7(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER7);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver8(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER8);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
     ...
     * @throws Exception
     */
    protected EntityFieldError onCheckField_Reserver9(boolean bBaseMode,OrgSecUserType et, boolean bCreate, boolean bTempMode) throws Exception {
        //判断是否有值
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(OrgSecUserType.FIELD_RESERVER9);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected String onTestValueRule(String strDEFieldName,String strRule,IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        ...
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER2,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver2_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER3,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver3_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER4,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver4_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER5,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver5_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER6,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver6_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER7,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver7_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER8,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver8_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER9,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver9_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER10,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver10_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER11,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver11_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER12,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver12_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER13,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver13_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER14,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver14_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER15,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver15_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER16,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver16_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER17,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver17_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER18,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver18_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER19,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver19_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER20,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver20_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER21,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver21_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER22,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver22_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER23,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver23_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER24,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver24_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER25,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver25_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER26,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver26_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER27,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver27_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER28,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver28_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER29,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver29_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,OrgSecUserType.FIELD_RESERVER30,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))

...
import net.ibizsys.psrt.srv.wx.demodel.wxorgsector.ac.*;
import net.ibizsys.psrt.srv.wx.demodel.wxorgsector.dataset.*;
import net.ibizsys.psrt.srv.wx.demodel.wxorgsector.dataquery.*;
import net.ibizsys.psrt.srv.wx.entity.WXOrgSector;
import net.ibizsys.psrt.srv.wx.service.WXOrgSectorService;

/**
 * 实体[WXORGSECTOR]模型对象基类
 */
public abstract class WXOrgSectorDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WXOrgSector>  {
    ...
    public  WXOrgSectorService getRealService() {
        if(this.wXOrgSectorService==null) {
            try {
                this.wXOrgSectorService = (WXOrgSectorService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WXORGSECTORNAME - 微信部门名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WXOrgSector.FIELD_WXORGSECTORNAME);

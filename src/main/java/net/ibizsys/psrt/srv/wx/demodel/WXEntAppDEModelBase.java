...
import net.ibizsys.psrt.srv.wx.demodel.wxentapp.ac.*;
import net.ibizsys.psrt.srv.wx.demodel.wxentapp.dataset.*;
import net.ibizsys.psrt.srv.wx.demodel.wxentapp.dataquery.*;
import net.ibizsys.psrt.srv.wx.demodel.wxentapp.uiaction.*;
 ...
 * 实体[WXENTAPP]模型对象基类
 */
public abstract class WXEntAppDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WXEntApp>  {
    ...
    public  WXEntAppService getRealService() {
        if(this.wXEntAppService==null) {
            try {
                this.wXEntAppService = (WXEntAppService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WXENTAPPNAME - 微信企业应用名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WXEntApp.FIELD_WXENTAPPNAME);

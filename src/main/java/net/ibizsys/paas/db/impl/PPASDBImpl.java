 ...
 *
 */
public class PPASDBImpl extends DatabaseImpl
{
	private static final Log log = LogFactory.getLog(PPASDBImpl.class);
	...
	public DBCallResult callSql(java.sql.Connection connection,String strCommand, SqlParamList list, int nTimeOut)
	{
		...
		try
		{
			...
			PPASDataSetImpl dataSet = new PPASDataSetImpl(conn,cstmt);
			while (true)
			{

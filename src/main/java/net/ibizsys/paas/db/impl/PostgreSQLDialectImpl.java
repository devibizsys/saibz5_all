 ...
 *
 */
public class PostgreSQLDialectImpl extends DBDialectImpl
{
	private static final Log log = LogFactory.getLog(PostgreSQLDialectImpl.class);
	...
	public String getPagingSQL(String strSQL, int nStartPos, int nPageSize, String strMajor, String strMajorDirection, String strMinor, String strMinorDirection)
	{
		// 重新生成排序字段
				...
				script.append(" ) a1 limit %1$s offset %2$s ",nPageSize, nStartPos);
